  ...
  return (
    <MotionProvider>
      <motion.div
        ...
        className=" cursor-pointer relative flex flex-col text-center group border-foreground/50 border bg-foreground/10 p-4 transition-all ease-in-out duration-500 "
      >
        ...
        <div className="flex flex-col my-5 gap-5">
          ...
          <p className=" text-foreground/50 group-hover:text-foreground font-semibold">
            {id}
          </p>
        </div>

        <div className="h-[2px] w-1/6 bg-foreground/50 absolute left-1/2 -translate-x-1/2 -bottom-[1px] group-hover:w-1/3 group-hover:bg-foreground duration-500" />
      </motion.div>
    </MotionProvider>
  );
}
