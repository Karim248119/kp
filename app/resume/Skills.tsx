  ...
  return (
    <TabsContent value="Skills">
      <div className="flex flex-wrap justify-center sm:justify-start gap-4 ">
        <h1 className="md:text-3xl text-xl font-bold">My Skills</h1>
                ...
                <TooltipProvider key={index}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className=" flex justify-center items-center p-6  bg-foreground/10 rounded-lg  sm:text-3xl text-3xl  hover:text-main transition-all duration-300 cursor-pointer">
                        {skill.icon}
                      </div>
                    </TooltipTrigger>
                    <TooltipContent>
